...
Obs: a data de cadastro e atualização dos dados deve ser armazenada.
...
### 4) Instalação
A aplicação deverá estar disponível em uma imagem docker a partir do **docker-hub** e não deve exigir configurações/parãmetros. Ou seja, ao rodar a imagem, deve levantar a aplicação e funcionar.
