...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("peopleregistrationservice");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("peopleregistrationservice");
        ...
        config.getMapConfigs().put("br.com.softplan.peopleregistrationservice.domain.*", initializeDomainMapConfig(jHipsterProperties));
